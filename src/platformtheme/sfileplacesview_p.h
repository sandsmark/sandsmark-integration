...
#ifndef sfileplacESVIEW_P_H
#define sfileplacESVIEW_P_H

#include <QMouseEvent>

class SFilePlacesEventWatcher : public QObject
{
    Q_OBJECT

public:
    explicit SFilePlacesEventWatcher(QObject *parent = nullptr)
        : QObject(parent)
    {
    }
